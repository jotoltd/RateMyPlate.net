  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Saved Plates</h1>
          <p className="text-sm text-gray-500">{plates.length} plate{plates.length !== 1 ? "s" : ""} saved</p>
        </div>
      </div>
