  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-xl font-black text-app">Followers</h1>
          <p className="text-sm text-muted">{followers.length} {followers.length === 1 ? "person" : "people"} follow @{profile.username}</p>
        </div>
      </div>
