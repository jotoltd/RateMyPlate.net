...
import { Users, Upload, Star, Heart, Flame } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {!user && (
        <div className="mt-10 rounded-3xl border border-orange-500/30 bg-gradient-to-br from-orange-500/10 via-rose-500/5 to-transparent p-7 text-center">
          ...
          <h3 className="text-xl font-black text-app mb-2">Become a chef</h3>
          <p className="text-sm text-muted mb-5">Join free, upload your plates, and get rated by AI and the community. Your profile appears right here.</p>
